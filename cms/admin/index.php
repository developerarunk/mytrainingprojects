   ...
   <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Date', 'Count'],
          <?php 
        $element_text=['Active Posts','Draft Posts','Pendign Comments','Categories','Users','Subscribers', 'Comments'];
        $element_count=[$post_counts, $post_draft_count,$unapproved_comment_count,$categories_counts,$user_counts,$subscriber_count,$comment_counts];
